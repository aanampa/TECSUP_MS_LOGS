...
INSERT INTO log_proceso (sistema, entidad, identificador, contenido) 
VALUES 
    ('APPCOMERCIAL','Cliente','000001','Sistema iniciado correctamente'),
    ('APPCOMERCIAL','Cliente','000002','Base de datos inicializada'),
    ('APPCOMERCIAL','Cliente','000003','Datos de ejemplo cargados');
...
SELECT id_log_proceso, sistema, entidad, identificador, contenido, fecha_registro FROM log_proceso ORDER BY fecha_registro DESC;
